...
class GoalSavingsTableView extends React.Component {
  state = {
    swiping: true,
        ...
        <Item
          ...
          editButtonPressed={() =>
            this.setState({
              ...
              selectedItemCurrency: item.currency,
              selectedItemDate: item.date
            })
          }
        />
      );
      ...
      <>
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            <TextInput
              style={{ height: 40 }}
              onChangeText={selectedItemCategory =>
                this.setState({ selectedItemCategory })
              }
            ...
            <TextInput
              style={{ height: 40 }}
              onChangeText={selectedItemDescription =>
            ...
            <TextInput
              style={{ height: 40 }}
              onChangeText={selectedItemDate =>
                this.setState({ selectedItemDate })
              }
            ...
            <TextInput
              style={{ height: 40 }}
              onChangeText={selectedItemAmount =>
                this.setState({ selectedItemAmount })
              }
            ...
            <TextInput
              style={{ height: 40 }}
              onChangeText={selectedItemCurrency =>
                this.setState({ selectedItemCurrency })
              }
...
export default GoalSavingsTableView;
